...
class EvaluationApprovalActionTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_manager_can_approve_evaluation()
    {
        ...
        // Simulate approval action through service
        $this->actingAs($manager);
        app(\App\Services\EvaluationService::class)->approveEvaluation($evaluation->id, $manager->id);
        
        // Refresh the evaluation from database
        $evaluation->refresh();
        
        // Assert the evaluation status is now approved
    ...
    public function test_admin_can_approve_evaluation()
    {
        ...
        // Simulate approval action through service
        $this->actingAs($admin);
        app(\App\Services\EvaluationService::class)->approveEvaluation($evaluation->id, $admin->id);
    ...
    public function test_evaluator_cannot_approve_evaluation()
    {
        $this->seed();
        ...
        // Attempt to approve as evaluator should fail
        ...
        app(\App\Services\EvaluationService::class)->approveEvaluation($evaluation->id, $evaluator->id);
